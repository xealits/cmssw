...
hpsTauIDSources = [
    ...
    ("byLooseCombinedIsolationRhoCorr3Hits", "DiscriminationByLooseCombinedIsolationRhoSumPtCorr3Hits"),
    ("byMediumCombinedIsolationRhoCorr3Hits", "DiscriminationByMediumCombinedIsolationRhoSumPtCorr3Hits"),
    ("byTightCombinedIsolationRhoCorr3Hits", "DiscriminationByTightCombinedIsolationRhoSumPtCorr3Hits"),
    ("byCombinedIsolationRhoCorrRaw3Hits", "DiscriminationByRawCombinedIsolationRhoSumPtCorr3Hits"),
